...
const UI_OVERRIDES = {
  ...
  "--project-skills-status": {
    exposeInWebUI: true,
    label: "Project Skills Status",
    description: "Reads the project skills allowlist and pin status.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 10,
    params: [{ name: "json", type: "bool", required: false }],
  ...
  "--skills-list": {
    exposeInWebUI: true,
    label: "Skills Registry List",
    description: "Lists globally available skills from SKILLS.json.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 20,
    params: [
  ...
  "--skills-show": {
    exposeInWebUI: true,
    label: "Skill Details",
    description: "Shows one skill package summary and preview content.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 30,
    params: [
      { name: "skill", type: "string", required: true },
      { name: "max-lines", type: "int", required: false },
      { name: "json", type: "bool", required: false },
    ],
    defaultArgs: { json: true },
  },
  "--project-skills-allow": {
    exposeInWebUI: true,
    label: "Allow Skill",
    description: "Adds skills into the project allowlist.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 40,
    params: [
      { name: "skill", type: "string", required: false },
  ...
  "--project-skills-deny": {
    exposeInWebUI: true,
    label: "Deny Skill",
    description: "Removes skills from the project allowlist.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 50,
    params: [
  ...
  "--skills-draft": {
    exposeInWebUI: true,
    label: "Create Skills Draft",
    description: "Creates a deterministic draft from scope evidence.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 60,
    params: [
  ...
  "--skills-refresh": {
    exposeInWebUI: true,
    label: "Refresh Skills Check",
    description: "Validates published skills and opens refresh drafts.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 70,
    params: [
  ...
  "--skills-governance": {
    ...
    description: "Runs or reads skills governance status.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 80,
    params: [
      { name: "run", type: "bool", required: false },
      { name: "status", type: "bool", required: false },
      { name: "json", type: "bool", required: false },
      { name: "dry-run", type: "bool", required: false },
    ],
    defaultArgs: { status: true, json: true },
  },
  "--skills-approve": {
    exposeInWebUI: true,
    label: "Approve Draft",
    description: "Approves a governance draft for publishing eligibility.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 90,
    params: [
      { name: "session", type: "string", required: false },
      { name: "draft", type: "string", required: false },
      { name: "by", type: "string", required: true },
      { name: "notes", type: "string", required: false },
      { name: "dry-run", type: "bool", required: false },
    ],
  ...
  "--skills-reject": {
    exposeInWebUI: true,
    label: "Reject Draft",
    description: "Rejects a governance draft.",
    group: "Lane A → Skills",
    tab: "Skills",
    order: 100,
    params: [
